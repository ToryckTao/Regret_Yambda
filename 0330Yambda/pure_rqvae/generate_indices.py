#!/usr/bin/env python3
"""
从训练好的 ckpt 导出所有 item 的离散 Token 序列，保存为 .json。
用法:
    python generate_indices.py \
        --ckpt checkpoints/.../best_collision_e100.pth \
...
def main():
    ...
    # 从 state_dict 推断超参
    enc_keys = [k for k in state_dict.keys() if 'encoder' in k and 'weight' in k]
