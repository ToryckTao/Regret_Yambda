...
data_path="/root/autodl-tmp/data/HSRL/dataset/rl4rs/rl4rs-dataset/"
output_path="/root/autodl-tmp/data/HSRL/HSRL/output/rl4rs/"
...
do
    ...
    do
        python train_env.py\
            ...
            --train_file ${data_path}rl4rs_dataset_b_sl.csv\
