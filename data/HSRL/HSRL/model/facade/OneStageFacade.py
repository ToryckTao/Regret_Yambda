...
#                 self.noise_var -= self.noise_decay
    ...
    def sample_buffer(self, batch_size):
        '''
        Batch sample is organized as a tuple of (observation, policy_output, reward, done_mask, next_observation, feedback)
        '''
        ...
        return observation, policy_output, reward, done_mask, next_observation, F
