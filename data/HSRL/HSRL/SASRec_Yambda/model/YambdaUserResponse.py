from .general import BaseModel
from .components import DNN
import torch
...
class YambdaUserResponse(BaseModel):
    ...
    def _define_params(self, args, reader):
        ...
        # portrait embedding (如果 portrait_len 为 0，使用可学习的默认嵌入)
    ...
    def get_forward(self, feed_dict: dict) -> dict:
        ...
        # rec item attention score (B,L) - 线性输出，不使用 Sigmoid
