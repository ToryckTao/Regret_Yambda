"""
RRCA + RAPI 训练脚本
基于 SARA_Yambda/train_sara.py 修改
使用 SARA_Session_Agent（含用户独立后悔池）
"""
...
# RRCA Agent
from Regret_HSAC.SARA_Session_Agent import SARA_Session_Agent
...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--agent_class', type=str, default='SARA_Session_Agent', help='Learning agent class')
