...
output_path="output/yambda_hsrl/"
...
# Dynamic SAVE_DIR
SAVE_DIR="${output_path}agents/superddpg_${SCORER}_actor${ACTOR_LR}_critic${CRITIC_LR}_behave${BEHAVE_LR}_niter${N_ITER}_reg${REG}_ep0_noise${NOISE}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}/"
...
python test_yambda.py "${args[@]}" > "${SAVE_DIR}test_log"
echo "DONE. See:"
